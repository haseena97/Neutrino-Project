...
! zion    = number of protons
	integer ::v !declare kat sini..pakai v sbb huruf lain diorang dah pakai dlm ni
      integer, parameter :: ionmax=3
      real*8             :: xmass(ionmax),ymass(ionmax), &
                            aion(ionmax),zion(ionmax),temp,den,abar,zbar, &
                            pair,plas,phot,brem,recomb,total,index,rad,temp,den,rm,m,templ,denl
                            !letak variable txt dlm ni sbb dah declare real kat sini
...
! get abar and zbar
      call azbar(xmass,aion,zion,ionmax,ymass,abar,zbar)


!  set the thermodynamic state
	!integer :: m
	!real :: index,rad,temp,den,rm,m,templ,denl..jgn letak dlm ni
...
! get the neutrino losses
      call sneut4(temp,den,zbar,abar, &
                  pair,plas,phot,brem,recomb,total)
...
! declare the pass
      real*8 :: temp,den,zbar,abar, &
                pair,plas,phot,brem,recomb,total

! local variables
      real*8 :: xmue,t9,xl,xlp5,xl2,xl3,xl4,xl5,xl6,xl8,xl9, &
                ...
                gbrem,a0,a1,a2,a3,b1,b2,b3,c00, &
...
! equation 5.9
       xnum  = 1.0d0/( (1.0d0 + rm*1d-9) &
                      * (230.0d0 + 6.7d5*t8m2 + 7.66d9*t8m5) )
